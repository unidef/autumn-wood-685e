...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/autumn-wood-685e#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/autumn-wood-685e
```

A live public deployment of this template is available at [https://autumn-wood-685e.templates.workers.dev](https://autumn-wood-685e.templates.workers.dev)
